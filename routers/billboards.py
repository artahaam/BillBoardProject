...
@router.post('/admin/billboards/add', response_model=schemas.BillBoardAdd)
...
@router.get('/admin/billboard/{id}/', response_model=schemas.BillBoardRead)
...
@router.get('/admin/billboards/', response_model=list[schemas.BillBoardRead])
